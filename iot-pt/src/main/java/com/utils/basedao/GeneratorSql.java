...
/**
*   @desc : SQL语句生成工具 Map<String,Object>包含sql(查询语句)、values(映射字段)
*   @auth : TYF
*   @data : 2019-01-25 - 14:57
*/
@Component
public class GeneratorSql {
    ...
    *   @desc : 高级查询
    *   @auth : TYF
    *   @params : selective(挑选字段)、params(基本条件)、searchBeans(高级条件)、pageOrderConfig(分页条件)
    *   @return :
    *   @data : 2019-01-25 - 15:27
    */
    ...
    *   @desc : 按照条件更新
    *   @auth : TYF
    *   @params : tableName(表名)、fields(待更新字段k-v)、params(基本条件k-v)、searchBeans(高级条件字段集合)
    *   @return :
    *   @data : 2019-01-25 - 15:59
    */
